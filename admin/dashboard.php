                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-sm-12 mb-3">
                            <a href="manage_users.php" class="btn btn-primary btn-block d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-md-6 col-sm-12 mb-3">
                            <a href="manage_satsang.php" class="btn btn-warning btn-block d-flex align-items-center justify-content-center">
                                <i class="fas fa-video mr-2"></i>Manage Satsang
                            </a>
                        </div>
                        <div class="col-md-6 col-sm-12 mb-3">
                            <a href="../index.php" class="btn btn-secondary btn-block d-flex align-items-center justify-content-center">
                                <i class="fas fa-home mr-2"></i>View Homepage
                            </a>
                        </div>
                        <div class="col-md-6 col-sm-12 mb-3">
                            <a href="../logout.php" class="btn btn-danger btn-block d-flex align-items-center justify-content-center">
